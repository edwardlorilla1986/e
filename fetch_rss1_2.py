        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    ...
                    subject=blog_content["title"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('*', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('The title of the blog post is', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', ''),
                    content = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace('"', '').replace('<br>', '').replace('*', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '').replace('\n', '<br>'),
                ...
                summary = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
                content = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
