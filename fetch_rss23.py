        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    ...
                    content=blog_content["blog"].replace('Here's a polished and professional version of the blog post:', '').replace('Here is the edited blog post:', '').replace('Here is the revised blog post:', '').replace("\n", "<br>").replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', ''),
                ...
                summary = blog_content["blog"].replace('Here's a polished and professional version of the blog post:', '').replace('Here is the edited blog post:', '').replace('Here is the revised blog post:', '').replace("\n", "<br>").replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
                content = blog_content["blog"].replace('Here's a polished and professional version of the blog post:', '').replace('Here is the edited blog post:', '').replace('Here is the revised blog post:', '').replace("\n", "<br>").replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
