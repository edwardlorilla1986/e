...
class AICrew:
    ...
    def edit_content(self, content):
        ...
        """
        return self.run_ollama(prompt)
def get_ollama_response(input_text, no_words, blog_style, word_of_the_day, model_name="llama3-chatqa-chatqa-chatqa"):
    ...
    for entry in existing_entries:
        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    recipient_email="edwardlorilla2223.edwardlancelorilla@blogger.com",
