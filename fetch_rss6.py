        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    ...
                    subject=blog_content["title"].replace('*', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it:', ''),
                    content=blog_content["blog"].replace('*', '').replace('Here's a polished and professional version of the blog post:', '')
                )
