...
def insert_blog_post_to_db(title, summary, content, keywords, slug, thumbnail):
    ...
    """
    values = (
        "en", title.replace('The title is', '').replace("Here's the revised blog post", '').replace('The title of this blog post is', '').strip('"').replace('\n', ' '), 1, 1,
        1, title.replace('The title is', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '), title.replace('The title is', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '), title.replace('The title is', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '),
