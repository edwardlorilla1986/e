...
def insert_blog_post_to_db(title, summary, content, keywords, slug, thumbnail):
    ...
    """
    values = (
        "en", title.replace('The title is', '').replace('The title of this rewritten blog post is').replace('The title of this blog post is', '').strip('"').replace('\n', ' '), 1, 1,
        1, title.replace('The title is', '').replace('The title of this rewritten blog post is').strip('"').replace('\n', ' '), title.replace('The title is', '').replace('The title of this rewritten blog post is').strip('"').replace('\n', ' '), title.replace('The title is', '').replace('The title of this rewritten blog post is').strip('"').replace('\n', ' '),
