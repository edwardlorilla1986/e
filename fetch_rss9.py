...
if os.path.exists(seed_file):
    ...
    seed = 1
rss_url = 'https://interaksyon.philstar.com/feed/'
...
def get_ollama_response(input_text, no_words, blog_style, word_of_the_day, model_name="llama3"):
    ...
    prompts = [
        ...
        """,
        f"wriite a title of the blog post and Write a blog {blog_style}: Why {input_text} No Longer Works in {today_year} and What to Do Instead. Be around {no_words} words and include '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog How {blog_style} Professionals Can Benefit from {input_text} in {today_year}. Write {no_words} words and creatively use '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog 5 Underrated Tools for {blog_style} Professionals to Master {input_text} in {today_year}. Cover this in {no_words} words with '{word_of_the_day}' included.",
        f"wriite a title of the blog post and Write a blog What {input_text} Means for {blog_style} Professionals in {today_year}. Analyze in {no_words} words while emphasizing '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog How {blog_style} Professionals Can Master {input_text} in {today_year}. Provide actionable tips in {no_words} words and include '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog Why {input_text} Is Critical for {blog_style} Success in {today_year}. Dive into the topic in {no_words} words, using '{word_of_the_day}' naturally.",
        f"wriite a title of the blog post and Write a blog Lessons on {input_text} for {blog_style} Professionals in {today_year}. Share insights in {no_words} words, creatively using '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog The Evolution of {input_text} for {blog_style} Professionals in {today_year}. Cover its journey in {no_words} words and include '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog How {blog_style} Professionals Can Overcome Challenges with {input_text} in {today_year}. Offer solutions in {no_words} words, using '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog Behind the Scenes: {input_text} for {blog_style} in {today_year}. Unveil insights in {no_words} words with a focus on '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog Top Strategies for {blog_style} Professionals to Excel in {input_text} in {today_year}. Outline in {no_words} words while incorporating '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog 5 Ways {blog_style} Professionals Can Leverage {input_text} in {today_year}. Highlight approaches in {no_words} words, using '{word_of_the_day}' creatively.",
        f"wriite a title of the blog post and Write a blog The Role of {input_text} in {blog_style} Growth in {today_year}. Explain in {no_words} words while weaving in '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog Why {input_text} Matters for {blog_style} in {today_year}. Discuss its significance in {no_words} words and incorporate '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog The Future of {input_text} for {blog_style} Professionals Beyond {today_year}. Speculate in {no_words} words, making '{word_of_the_day}' central to the narrative.",
        f"wriite a title of the blog post and Write a blog 5 Key Insights on {input_text} for {blog_style} in {today_year}. Provide them in {no_words} words and include '{word_of_the_day}' creatively.",
        f"wriite a title of the blog post and Write a blog How {input_text} Is Shaping the Future of {blog_style} in {today_year}. Write {no_words} words and make '{word_of_the_day}' a focus point.",
        f"wriite a title of the blog post and Write a blog The Importance of {input_text} for {blog_style} Professionals in {today_year}. Highlight why in {no_words} words, incorporating '{word_of_the_day}' naturally.",
        f"wriite a title of the blog post and Write a blog How to Use {input_text} Effectively as a {blog_style} Professional in {today_year}. Cover this in {no_words} words, using '{word_of_the_day}' practically.",
        ...
        f"wriite a title of the blog post and Write a blog 5 Lessons Learned from {input_text} for {blog_style} Professionals in {today_year}. Share these in {no_words} words while incorporating '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog The Power of {input_text} for {blog_style} in {today_year}. Explain its influence in {no_words} words, ensuring '{word_of_the_day}' is highlighted.",
        f"wriite a title of the blog post and Write a blog Why {input_text} Should Be a Priority for {blog_style} in {today_year}. Discuss in {no_words} words while weaving '{word_of_the_day}' into the narrative.",
        f"wriite a title of the blog post and Write a blog How {blog_style} Professionals Can Improve Their Work Through {input_text} in {today_year}. Cover this in {no_words} words and use '{word_of_the_day}'.",
        f"wriite a title of the blog post and Write a blog The Impact of {input_text} on {blog_style} Success in {today_year}. Analyze in {no_words} words while making '{word_of_the_day}' central to the discussion.",
        f"wriite a title of the blog post and Write a blog The Role of {input_text} in Transforming {blog_style} in {today_year}. Write about this in {no_words} words, ensuring '{word_of_the_day}' is included.",
        f"wriite a title of the blog post and Write a blog How {input_text} Can Revolutionize {blog_style} in {today_year}. Explore the potential in {no_words} words with '{word_of_the_day}' creatively used.",
        f"wriite a title of the blog post and Write a blog The Ultimate Guide to {input_text} for {blog_style} Professionals in {today_year}. Write this in {no_words} words, incorporating '{word_of_the_day}' throughout."
    ...
    for entry in existing_entries:
        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    recipient_email="edwardlorilla2209.edwardlancelorilla@blogger.com",
                    subject=blog_content["title"].replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('*', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it:', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', ''),
<<<<<<< HEAD
                    content=blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', ''),
=======
                    content=blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', ''),
>>>>>>> 9b956ef7b526db0e77b9dad4ff44699a30a13fea
                    attachment_path=file_name
                )
                title = blog_content["title"].replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('*', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it:', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
<<<<<<< HEAD
                summary = blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
                content = blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
=======
                summary = blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
                content = blog_content["blog"].replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace(':', '').replace('"', '').replace('<br>', '').replace('*', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post:', '').replace('\n', '<br>').replace('The title is:', '').replace('The title of this blog post is:', '').replace('Here is a polished and professional version of the blog post:', '')
>>>>>>> 9b956ef7b526db0e77b9dad4ff44699a30a13fea
